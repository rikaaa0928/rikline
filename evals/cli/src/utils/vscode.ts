...
`,
	...
	const settings = {
		...
		"workbench.view.extension.rikaaa0928.rikline-ActivityBar.visible": true,
	...
	const keybindings = [
		{
			key: "alt+c",
			command: "workbench.view.extension.rikaaa0928.rikline-ActivityBar",
			when: "viewContainer.workbench.view.extension.rikaaa0928.rikline-ActivityBar.enabled",
		},
		{
			key: "alt+shift+c",
	...
	const args = [
		...
		"--command",
		"workbench.view.extension.rikaaa0928.rikline-ActivityBar",
	...
	const startupScript = `
		...
		setTimeout(() => {
			...
			require('vscode').commands.executeCommand('workbench.view.extension.rikaaa0928.rikline-ActivityBar');
			...
			function activate(context) {
				...
				let disposable = vscode.commands.registerCommand('cline-activator.activate', async function () {
					try {
						...
						const extension = vscode.extensions.getExtension('rikaaa0928.rikline');
						if (!extension) {
						...
						await vscode.commands.executeCommand('workbench.view.extension.rikaaa0928.rikline-ActivityBar');
