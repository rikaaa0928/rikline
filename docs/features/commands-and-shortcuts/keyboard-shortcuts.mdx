...
| [`cline.createConventionalCommitMessage`](/features/commands-and-shortcuts/git-integration) | Creates a conventional commit message with wizard |
...
| `rikline.SidebarProvider.focus` | Opens and focuses the Cline sidebar |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `rikline.SidebarProvider.focus`           | Opens the Cline sidebar panel |
